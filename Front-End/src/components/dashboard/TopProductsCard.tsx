...
export default function TopProductsCard({ data, loading }: TopProductsCardProps) {
        ...
        <div className="mb-6">
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={chartData}>
              ...
              />
              <Legend />
              <Bar dataKey="Số lượng bán" fill="#8b5cf6" radius={[8, 8, 0, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-3 mt-1">
                  <span className="text-xs text-gray-600">
                    Đã bán: <span className="font-semibold text-purple-600">{product.totalQuantitySold}</span>
                  </span>
