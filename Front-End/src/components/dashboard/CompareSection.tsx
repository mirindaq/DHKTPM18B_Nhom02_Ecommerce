...
interface CompareSectionProps {
  ...
  onClose: () => void
  data1?: RevenueByMonthResponse[] | RevenueByDayResponse[] | RevenueByYearResponse[]
  data2?: RevenueByMonthResponse[] | RevenueByDayResponse[] | RevenueByYearResponse[]
  loading?: boolean
}
...
export default function CompareSection({ onCompare, onClose, data1, data2, loading }: CompareSectionProps) {
  ...
  const calculateTotal = (data?: RevenueByMonthResponse[] | RevenueByDayResponse[] | RevenueByYearResponse[]) => {
  ...
  const revenuePercent = total2.revenue > 0 ? ((revenueDiff / total2.revenue) * 100) : 0
  ...
  return (
    <Card className="mb-6 border-2 border-purple-200 bg-purple-50/30">
      <CardHeader className="border-b border-purple-100">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <CardTitle className="text-lg font-bold text-gray-900">Chế độ so sánh</CardTitle>
          </div>
      ...
      <CardContent className="p-6">
          ...
          <div className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setPeriod1({ ...period1, timeType: value as any })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <>
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setPeriod1({ ...period1, month: Number(value) })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setPeriod1({ ...period1, year: Number(value) })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
          ...
          <div className="space-y-4 p-4 bg-white rounded-lg border border-gray-200">
            ...
            <div className="space-y-2">
              ...
              <Select 
                ...
                onValueChange={(value) => setPeriod2({ ...period2, timeType: value as any })}
              >
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
              ...
              <>
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setPeriod2({ ...period2, month: Number(value) })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-2">
                  ...
                  <Select 
                    ...
                    onValueChange={(value) => setPeriod2({ ...period2, year: Number(value) })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
        ...
        <Button onClick={handleCompare} className="w-full bg-purple-600 hover:bg-purple-700" disabled={loading}>
        ...
        {data1 && data2 && !loading && (
          <div className="mt-6 p-4 bg-white rounded-lg border border-gray-200">
            <h4 className="font-semibold text-gray-900 mb-4">Kết quả so sánh</h4>
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700">Chỉ tiêu</th>
                    <th className="px-4 py-3 text-right text-sm font-semibold text-gray-700">Kỳ 1</th>
                    <th className="px-4 py-3 text-right text-sm font-semibold text-gray-700">Kỳ 2</th>
                    <th className="px-4 py-3 text-right text-sm font-semibold text-gray-700">Chênh lệch</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    <td className="px-4 py-3 text-sm font-medium text-gray-900">Doanh thu</td>
                    ...
                    <td className={`px-4 py-3 text-sm text-right font-semibold ${
                      ...
                      {revenueDiff >= 0 ? '+' : ''}{revenueDiff.toLocaleString('vi-VN')} ₫
                  ...
                  <tr>
                    <td className="px-4 py-3 text-sm font-medium text-gray-900">Đơn hàng</td>
                    <td className="px-4 py-3 text-sm text-right text-gray-900">{total1.orders}</td>
                    <td className="px-4 py-3 text-sm text-right text-gray-900">{total2.orders}</td>
                    <td className={`px-4 py-3 text-sm text-right font-semibold ${
