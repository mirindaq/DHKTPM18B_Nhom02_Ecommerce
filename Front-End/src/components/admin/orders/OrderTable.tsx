...
import { Eye, Loader2, Search, Package, Truck, CheckCircle, Clock, AlertCircle, XCircle } from "lucide-react";
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-gray-50 hover:bg-gray-50">
            ...
            <TableHead className="font-semibold text-gray-700">SĐT người nhận</TableHead>
            <TableHead className="font-semibold text-gray-700">Tổng tiền</TableHead>
            <TableHead className="font-semibold text-gray-700">Trạng thái</TableHead>
            <TableHead className="font-semibold text-gray-700">Loại nhận hàng</TableHead>
                ...
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-gray-400">
                      {searchTerm ? "Thử tìm kiếm với từ khóa khác" : "Các đơn hàng sẽ hiển thị tại đây"}
                    </p>
                  </div>
                </div>
              </TableCell>
            ...
            orders.map((order, index) => {
              ...
              return (
                <TableRow key={order.id} className="hover:bg-gray-50 transition-colors duration-200">
                  ...
                  <TableCell className="text-gray-600">{order.receiverPhone}</TableCell>
